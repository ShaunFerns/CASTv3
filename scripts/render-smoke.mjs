...
const serverEnv = {
  ...
  CAST_BOOTSTRAP_ADMIN_EMAIL: process.env.CAST_BOOTSTRAP_ADMIN_EMAIL ?? "bootstrap-admin@example.edu",
  CAST_BOOTSTRAP_ADMIN_NAME: process.env.CAST_BOOTSTRAP_ADMIN_NAME ?? "CAST Bootstrap Admin",
  CAST_BOOTSTRAP_ADMIN_PASSWORD: process.env.CAST_BOOTSTRAP_ADMIN_PASSWORD ?? "Use-A-Strong-Password-2026!",
  CAST_BOOTSTRAP_INSTITUTION_NAME: process.env.CAST_BOOTSTRAP_INSTITUTION_NAME ?? "CAST Preview Institution",
  CAST_BOOTSTRAP_INSTITUTION_SLUG: process.env.CAST_BOOTSTRAP_INSTITUTION_SLUG ?? "cast-preview",
