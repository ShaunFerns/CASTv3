...
CREATE VIEW compat_legacy_module_reviews AS
SELECT
...
CREATE VIEW compat_legacy_programmes AS
SELECT
...
CREATE VIEW compat_legacy_programme_modules AS
SELECT
...
CREATE VIEW compat_legacy_ga_classifications AS
SELECT
...
CREATE VIEW compat_legacy_audit_logs AS
SELECT
